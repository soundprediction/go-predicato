...
-- Create extracted_triples table with all columns
...
-- Migrate data from extracted_edges
INSERT OR IGNORE INTO extracted_triples (id, source_id, group_id, subject, subject_type, predicate, object, object_type, description, confidence, embedding, chunk_index, model, created_at)
