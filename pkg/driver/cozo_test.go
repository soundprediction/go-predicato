...
func TestNewCozoDriver(t *testing.T) {
	t.Run("in-memory", func(t *testing.T) {
		d, err := driver.NewCozoDriver("", 1024)
		require.NoError(t, err)
		require.NotNil(t, d)
		assert.Equal(t, driver.GraphProviderCozo, d.Provider())
		require.NoError(t, d.Close())
	})
}

func TestCozoDriverInterface(t *testing.T) {
	var _ driver.GraphDriver = (*driver.CozoDriver)(nil)
}

func TestCozoDriver_CreateIndices(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_UpsertNode(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_GetNodes(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_DeleteNode(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_UpsertEdge(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_DeleteEdge(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_SearchNodes(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_GetNeighbors(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_GetStats(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_GetEntityNodesByGroup(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_GetAllGroupIDs(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_VectorSearch(t *testing.T) {
	d, err := driver.NewCozoDriver("", 3) // small embedding dim for testing
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_TimeRange(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
...
func TestCozoDriver_GraphExporter(t *testing.T) {
	d, err := driver.NewCozoDriver("", 1024)
	require.NoError(t, err)
	defer d.Close()
